...
def count_and_list_words(file_name):
    
    # Insert here the text file path and the negative_words path so it can read and generate the plot
    text_path = f'C:\\Users\\attil\\Desktop\\DEV\\Git Arthur Attili\\Privados\\Literatutu\\{file_name}'
    negative_words_path = 'C:\\Users\\attil\\Desktop\\DEV\\Git Arthur Attili\\Privados\\Literatutu\\Negative_Words.txt'
